...
<script type="text/javascript" >
  ...
  function save(id) {//未定义是可能就是id重复了
    ...
    window.location.href="${pageContext.request.contextPath}/uptype?caseId="+id+"&type="+content;
  }

  function back() {
    window.location.href="${pageContext.request.contextPath}/allCase";
  }
  function del(id) {
    window.location.href="${pageContext.request.contextPath}/deltype?caseId="+id;
  }
...
<div class="tpl-page-container tpl-page-header-fixed">
  ...
  <div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
      <li>
        <a href="${pageContext.request.contextPath}/main" class="am-icon-home">首页</a>
      </li>
      <li class="am-active">
        添加律师
      </li>
                    ...
                    <div class="am-btn-toolbar">
                      <div class="am-btn-group am-btn-group-xs">
                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"
                                type="button" onclick="editFile(${t.caseId})">
                          <span class="am-icon-edit"></span> 编辑
                        </button>
                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                                type="button" onclick="submitHand(${t.caseId})">
