...
<%--                            <c:if test="${message.is_read==1}">--%>
                                ...
                                <span style="font-weight: bold">zm</span> 回复了你<br>
                                <span style="font-weight: bold">内容: </span>${message.content}<br>
<%--                                <a href="/message/read/${message.topic_id}"><span style="font-weight: bold">查看主题: </span>${message.title}</a>--%>
                                <a ><span style="font-weight: bold">查看主题: </span>${message.title}</a>
<%--                            </c:if>--%>
                        </li>
                        </c:if>
                    </c:forEach>
